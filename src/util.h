 ...
 */
#ifndef MULECOIN_UTIL_H
#define MULECOIN_UTIL_H
...
extern const char *const MULECOIN_CONF_FILENAME;
extern const char *const MULECOIN_PID_FILENAME;
...
{
    std::string s = strprintf("mulecoin-%s", name);
