...
#ifndef MULECOIN_TEST_SCRIPTNUM10_H
#define MULECOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Mulecoin Core 0.10.0, for cross-comparison.
 */
public:
