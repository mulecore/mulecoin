...
#ifndef MULECOIN_SCRIPT_STANDARD_H
#define MULECOIN_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_MULECOIN_ASSET script that carries data
    /** FOXD END */
};
...
/**
 * Generate a Mulecoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // MULECOIN_SCRIPT_STANDARD_H
