...
#ifndef MULECOIN_SCRIPT_SCRIPT_H
#define MULECOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Mulecoin always counted CHECKMULTISIGs
...
#endif // MULECOIN_SCRIPT_SCRIPT_H
