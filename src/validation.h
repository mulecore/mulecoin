...
#ifndef MULECOIN_VALIDATION_H
#define MULECOIN_VALIDATION_H
...
/** Block download timeout base, expressed in millionths of the block interval (i.e. 10 min) */ // TODO Should we change this for mulecoin, with 1 minutes block intervals?
