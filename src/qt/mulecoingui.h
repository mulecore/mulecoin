...
#ifndef MULECOIN_QT_MULECOINGUI_H
#define MULECOIN_QT_MULECOINGUI_H
...
/**
  Mulecoin GUI main class. This class represents the main window of the Mulecoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class MulecoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit MulecoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~MulecoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a mulecoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // MULECOIN_QT_MULECOINGUI_H
