...
#ifndef MULECOIN_QT_OPTIONSMODEL_H
#define MULECOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Mulecoin client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // MulecoinUnits::Unit
...
#endif // MULECOIN_QT_OPTIONSMODEL_H
