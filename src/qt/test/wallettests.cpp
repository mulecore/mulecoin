...
#include "qt/mulecoinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<MulecoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_mulecoin-qt -platform xcb      # Linux
//     src/qt/test/test_mulecoin-qt -platform windows  # Windows
//     src/qt/test/test_mulecoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = MulecoinUnits::formatWithUnit(unit, balance, false, MulecoinUnits::separatorAlways);
    ...
    // Amount input
    MulecoinAmountField* amountInput = receiveCoinsDialog.findChild<MulecoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: mulecoin:")) != -1);
