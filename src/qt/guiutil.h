...
#ifndef MULECOIN_QT_GUIUTIL_H
#define MULECOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Mulecoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "mulecoin:" URI into recipient object, return true on successful parsing
