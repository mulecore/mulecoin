...
#ifndef MULECOIN_QT_MULECOINUNITS_H
#define MULECOIN_QT_MULECOINUNITS_H
...
/** Mulecoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MulecoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MulecoinUnits(QObject *parent);

    /** Mulecoin units.
      @note Source: https://en.mulecoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        FOXD,
...
typedef MulecoinUnits::Unit MulecoinUnit;

#endif // MULECOIN_QT_MULECOINUNITS_H
