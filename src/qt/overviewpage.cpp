...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(MulecoinUnits::FOXD),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(MulecoinUnits::formatWithUnit(unit, balance, false, MulecoinUnits::separatorAlways));
    ui->labelUnconfirmed->setText(MulecoinUnits::formatWithUnit(unit, unconfirmedBalance, false, MulecoinUnits::separatorAlways));
    ui->labelImmature->setText(MulecoinUnits::formatWithUnit(unit, immatureBalance, false, MulecoinUnits::separatorAlways));
    ui->labelTotal->setText(MulecoinUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, MulecoinUnits::separatorAlways));
    ui->labelWatchAvailable->setText(MulecoinUnits::formatWithUnit(unit, watchOnlyBalance, false, MulecoinUnits::separatorAlways));
    ui->labelWatchPending->setText(MulecoinUnits::formatWithUnit(unit, watchUnconfBalance, false, MulecoinUnits::separatorAlways));
    ui->labelWatchImmature->setText(MulecoinUnits::formatWithUnit(unit, watchImmatureBalance, false, MulecoinUnits::separatorAlways));
    ui->labelWatchTotal->setText(MulecoinUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, MulecoinUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("FOXD")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the FOXD balance grid from expanding and looking terrible when asset balance is hidden
