...
#ifndef MULECOIN_QT_RECEIVECOINSDIALOG_H
#define MULECOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of mulecoins */
...
#endif // MULECOIN_QT_RECEIVECOINSDIALOG_H
