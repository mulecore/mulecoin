...
#ifndef MULECOIN_QT_SENDASSETSENTRY_H
#define MULECOIN_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending mulecoins.
...
#endif // MULECOIN_QT_SENDASSETSENTRY_H
