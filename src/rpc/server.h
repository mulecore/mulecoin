...
#ifndef MULECOIN_RPCSERVER_H
#define MULECOIN_RPCSERVER_H
...
/**
 * Mulecoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern CAmount AmountFromValue(const UniValue& value, bool p_isFOXD = true);
