...
"""
    ...
    Mulecoin should be started with the command line arguments:
        mulecoind -testnet -daemon \
    ...
    https://github.com/MulecoinProject/Mulecoin/blob/37a7fe9e440b83e2364d5498931253937abe9294/contrib/zmq/zmq_sub.py
"""
