...
This document provides guidelines for internationalization of the Mulecoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `mulecoin_en.ts` remains unchanged.
