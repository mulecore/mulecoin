Mulecoin Core version *2.1.0* is now available!!
==============

  <https://github.com/MulecoinProject/Mulecoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/MulecoinProject/Mulecoin/commits/release_2.1.0>
