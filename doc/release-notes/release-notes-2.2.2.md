Mulecoin Core version *2.2.2* is now available!!
==============

  <https://github.com/MulecoinProject/Mulecoin/releases/tag/v2.2.2>
...
Changelog available here: <https://github.com/MulecoinProject/Mulecoin/commits/release_2.2.2>
