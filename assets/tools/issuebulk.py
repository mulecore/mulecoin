...
# Prerequisite: mulecoind daemon to be running
...
#Set this to your mulecoin-cli program
cli = "mulecoin-cli"
...
#mode =  "-regtest"
#rpc_port = 18443
csv_file = "Mulecoin Assets - Sheet1.csv"
#Set this information in your mulecoin.conf file (in datadir, not testnet3)
rpc_user = 'rpcuser'
rpc_pass = 'rpcpass555'
