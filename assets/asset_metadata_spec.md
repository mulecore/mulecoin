...
**forsale_price** - To give buyers an idea of the cost to own and admin the asset token.   Price followed by a space, followed by the currency.  Examples: "10000 FOXD" or "0.3 BTC" or "50000 USD"  This might be parsed by token broker websites.
