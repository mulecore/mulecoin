...
class BIP66Test(MulecoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # mulecoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and mulecoind produces more specific reject
            # reasons.
