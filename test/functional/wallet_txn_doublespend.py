...
class TxnMallTest(MulecoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 FOXD:
        ...
        # First: use raw transaction API to send 1240 FOXD to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 FOXD coin each
        ...
        # Node0's balance should be starting balance, plus 50FOXD for another
        ...
        # Node0's total balance should be starting balance, plus 100FOXD for 
