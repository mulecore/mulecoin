...
import os
import struct
from test_framework.test_framework import MulecoinTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest (MulecoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that mulecoin has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("mulecoind has not been built with zmq enabled.")
