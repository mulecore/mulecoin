...
# TestNode: A peer we use to send messages to mulecoind, and store responses.
...
class CompactBlocksTest(MulecoinTestFramework):
    ...
    # This test actually causes mulecoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that mulecoind requests compact blocks when we announce new blocks
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # mulecoind will not send blocktxn responses for blocks whose height is
