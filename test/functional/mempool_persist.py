...
By default, mulecoind will dump mempool on shutdown and
...
class MempoolPersistTest(MulecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent mulecoind from writing mempool.dat to disk. Verify that `savemempool` fails")
