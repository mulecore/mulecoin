...
class TestMulecoinCli(MulecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `mulecoin-cli getinfo`")
        ...
        self.log.info("Compare responses from `mulecoin-cli -getinfo` and the RPCs data is retrieved from.")
