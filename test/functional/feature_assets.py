...
class AssetTest(MulecoinTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("MULECOIN1", 1000)
        n0.issue("MULECOIN2", 1000)
        n0.issue("MULECOIN3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="MULECOIN*", verbose=False, count=2, start=-2)
        ...
        mulecoin_assets = n0.listassets(asset="MULECOIN*", verbose=False, count=2, start=-2)
        assert_equal(len(mulecoin_assets), 2)
        assert_equal(mulecoin_assets[0], "MULECOIN2")
        assert_equal(mulecoin_assets[1], "MULECOIN3")
        self.sync_all()
