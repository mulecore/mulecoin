...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MulecoinTestFramework
    pass

class ExampleTest(MulecoinTestFramework):
    # Each functional test is a subclass of the MulecoinTestFramework class.
    ...
    def custom_method(self):
        ...
        MulecoinTestFramework class so other tests can use it."""
